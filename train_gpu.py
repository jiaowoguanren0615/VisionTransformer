...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'VisionTransformer training and evaluation script', add_help=False)
    ...
    parser.add_argument('--model', default='vit_base_patch16_224', type=str, metavar='MODEL',
                        choices=['vit_e_patch14_224_in21k', 'vit_Giant_patch14_224_in21k', 'vit_giant_patch14_224_in21k',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'VisionTransformer training and evaluation script', parents=[get_args_parser()])
